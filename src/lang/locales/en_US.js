module.exports = {
   ...
   "sidebar.tasks":"Tasks",
   "sidebar.assignTask":"Assign-Tasks",
   "sidebar.createTask":"Create-Tasks",
   "sidebar.client":"Client",
   "sidebar.location":"Location",
   "sidebar.invoices":"Invoices",
   "sidebar.user-manage":"Manage Users",
   "sidebar.profile":"Profile",
   "sidebar.pending":"Pending",
   "sidebar.home":"Home",
   "sidebar.surveyor":"Surveyor's",
   ...
   "sidebar.createForm" : "Create Form",
   "sidebar.userProfile1": "User Profile 1",
   "sidebar.userProfile2": "User Profile 2",
   "sidebar.userManagement": "Manage Users",
   "sidebar.createUser": "Register User",
   "sidebar.createform": "Create Form",
   "sidebar.userProfile": "User Profile",
   "sidebar.clientList": "Clients",
   "sidebar.surveyorList": "Surveyors",
   "sidebar.adminList": "Admins",
   "sidebar.clientTasks": "Client Tasks",
   "sidebar.calendar": "Calendar",
   "sidebar.cultures": "Cultures",
   "sidebar.admin":"create-user",
   "sidebar.subadmin":"sub-create-user",
   "sidebar.dnd": "Dnd",
   ...
   "sidebar.crm": "CRM",
   "sidebar.dashboard": "dashboard",
   "assignment.assignTask" : "Assign Tasks",
   "register.departmentAdd" : "Add Department",
   "register.registerUser" : "Register Users",
   "widgets.totalEarns": "Total Earns",
   "widgets.approvedTasks": "Approved Tasks",
   "widgets.totalActiveTask": "Total Active Tasks",
   "widgets.totalClientWidget": "Total Clients",
